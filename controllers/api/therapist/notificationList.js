...
notificationList = (req,res) => {
    ...
    //let SelectSql = "SELECT * FROM notifications WHERE user_id = '"+user_id+"' AND type='therapist_job_detail' ORDER BY id DESC";

    let SelectSql = "SELECT * FROM notifications WHERE user_id = '"+user_id+"' AND type IN('therapist_job_detail','detail') ORDER BY id DESC";
