...
counselorDetail = (req,res) => {
    ...
    let SelectSql = "SELECT  id,email,mobile_number,first_name,last_name,unic_id,profile_image,gender,qualification,years_experience,therapy_type,about_me,hpcsa_no FROM users_master WHERE unic_id = '"+unique_id+"' AND deleted_at is null";
...
module.exports = counselorDetail;
