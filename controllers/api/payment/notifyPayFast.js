  	...
  	if(listedarray.includes(ip.toString()) === true){
	    ...
	    dbConnection.query(SelectSql, { 
			...
			//Send email to admin on create booking
				var CUSTOMERNAME = requestsData[0].customer_first_name+' '+requestsData[0].customer_last_name;
