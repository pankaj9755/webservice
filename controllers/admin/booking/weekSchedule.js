...
weekSchedule = (req,res) => {
    ...
    let SelectSql = "Select users_master.id,therapist_schedule.day_number,therapist_schedule.schedule From users_master JOIN therapist_schedule ON users_master.id = therapist_schedule.therapist_id WHERE users_master.id = '"+req.body.id+"' AND is_open='yes' ";
