...
var deleteAssessment = (req, res) => {
  ...
  let select_query =
    "SELECT id FROM assessments WHERE id = :id AND deleted_at IS NULL";
  dbConnection
    .query(select_query, {
      replacements: { id: id },
    ...
    .then((result) => {
      ...
      let soft_delete_query =
        "UPDATE assessments SET deleted_at = :deleted_at WHERE id = :id";
      dbConnection
        ...
        .catch((err) => {
          console.error("Error in assessments.delete.js: " + err);
