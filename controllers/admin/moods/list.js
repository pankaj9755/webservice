...
var findAll = (req, res) => {
  ...
  let query =
    "SELECT id, title, code, image, status, created_at FROM moods WHERE deleted_at IS NULL";
  let que_cnt = "SELECT COUNT(id) AS total FROM moods WHERE deleted_at IS NULL";
  if (status != "") {
