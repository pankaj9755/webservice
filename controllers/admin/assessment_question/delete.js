...
deleteAssessmentQuestion = (req, res) => {
  let response = {};
  ...
  let query =
    "UPDATE assessment_questions SET deleted_at = :deleted_at WHERE id = :id";
  dbConnection
    ...
    .catch((err) => {
      console.error("Error into delete assessment question.js: " + err);
      res.statusCode = constants.SOMETHING_WENT_WRONG_STATUS_CODE;
      response.message = constants.SOMETHING_WENT_WRONG;
      return res.send(response);
    });
};
module.exports = deleteAssessmentQuestion;
